...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'mobile', 'gender', 'password', 'uuid', 'github_id', 'avatar', 'qq', 'wechat', 'github', 'github_id', 'wechat_openid', 'qq_openid',
    ];
     ...
     */
    protected $hidden = [
        'password', 'remember_token', 'github_id', 'wechat_openid', 'qq_openid',
    ];
